        ...
        if (empty($con_name)) {
            ...
            try {
                ...
                if ($row['con_name'] == $con_name) {
                    $_SESSION['warning'] = "มีหน้านี้อยู่ในระบบแล้ว <a href='/Project_910_MATCHLIFE/Role_admin/Content.php'>คลิ๊กที่นี่</a> เพื่อตรวจสอบ";
                    header("location: formAdd_content.php");
                    ...
                    $stmt->execute();
                    $_SESSION['success'] = "เพิ่มข้อมูลในหน้าใหม่เรียบร้อยแล้ว! <a href='/Project_910_MATCHLIFE/Role_admin/Content.php' class='alert-link'>คลิ๊กที่นี่</a> เพื่อตรวจสอบ";
                    header("location: formAdd_content.php");
                } else {
