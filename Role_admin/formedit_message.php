...
<body>
    ...
    if(isset($_GET['id'])){
      ...
      if($stmt->rowCount() < 1){
          header('Location: /Project_910_MATCHLIFE/Role_admin/Message.php');
          exit();
      }
    }//isset
    ?>
          ...
          <main class="py-10">
            ...
            <div class="container-xl">
              <div class="border bg-surface-secondary h-full border-dashed rounded  justify-content-center align-items-center" style="min-height: 400px;">
                ...
                <p>คลิ๊กที่นี่เพื่อย้อนกลับ <a href="/Project_910_MATCHLIFE/Role_admin/Message.php">ย้อนกลับ</a></p>

          <h4>ฟอร์มแก้ไขข่าว</h4>
          <form action="/Project_910_MATCHLIFE/Role_admin/formedit_db_message.php" method="post">

          <div class="row">
            <div class="col">
              <div class="clearfix">
                  <img src="/Project_910_MATCHLIFE/Role_admin/uploads/<?= $row['messages_img'];?>" width="100%">
              </div> 
            </div>
