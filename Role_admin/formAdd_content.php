...
<body>
    <div class="d-flex flex-column flex-lg-row h-lg-full bg-gray-50">
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/Project_910_MATCHLIFE/Role_admin/Content.php">
        ...
        <p>คลิ๊กที่นี่เพื่อย้อนกลับ <a href="/Project_910_MATCHLIFE/Role_admin/Content.php">ย้อนกลับ</a></p>

          <h4>ฟอร์มเพิ่มข้อมูล</h4>
          <form action="/Project_910_MATCHLIFE/Role_admin/formAdd_db_content.php" method="post">
          ...
          <div class="mb-3">
                <label for="con_name" class="form-label">ชื่อหน้า</label>
                <input type="text" class="form-control" name="con_name" aria-describedby="stdID">
            </div>
            <div class="mb-3">
                <label for="con_by" class="form-label">ชื่อผู้เพิ่มข้อมูล</label>
                <input type="text" class="form-control" name="con_by" aria-describedby="firstname">
            </div>
            <div class="mb-3">
                <label for="con_p1" class="form-label">ข้อมูลส่วนที่ 1</label>
                <input type="text" class="form-control" name="con_p1" aria-describedby="lastname">
            </div>
            <div class="mb-3">
                <label for="con_p2" class="form-label">ข้อมูลส่วนที่ 2</label>
                <input type="text" class="form-control" name="con_p2" aria-describedby="lastname">
            </div>
            <div class="mb-3">
                <label for="con_p3" class="form-label">ข้อมูลส่วนที่ 3</label>
                <input type="text" class="form-control" name="con_p3" aria-describedby="lastname">
            </div>
            <div class="mb-3">
                <label for="con_p4" class="form-label">ข้อมูลส่วนที่ 4</label>
                <input type="text" class="form-control" name="con_p4" aria-describedby="lastname">
            </div>
