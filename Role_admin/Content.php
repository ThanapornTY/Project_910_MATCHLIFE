    ...
    <div class="d-flex flex-column flex-lg-row h-lg-full bg-gray-50">
        ...
        <div class="h-screen flex-grow-1 overflow-y-lg-auto">
          ...
          <main class="py-10">
            ...
            <h3>รายการข้อมูล <a href="/Project_910_MATCHLIFE/Role_admin/formAdd_content.php" class="btn btn-info">+เพิ่มข้อมูล</a> </h3>
            <br>
              ...
              <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $k['con_by'];?></td>
                                <td><?= $k['created_at'];?></td>
                                <td><a href="formedit_content.php?id=<?= $k['con_id'];?>" class="btn btn-warning btn-sm">แก้ไข</a></td>
                                <td><a href="del_content.php?id=<?= $k['con_id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                  </table>
