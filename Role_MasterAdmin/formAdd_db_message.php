        ...
        if (empty($message_name)) {
            ...
            try {
                ...
                if ($row['message_name'] == $message_name) {
                    $_SESSION['warning'] = "มีหัวข้อข่าวนี้อยู่ในระบบแล้ว <a href='/Project_910_MATCHLIFE/Role_MasterAdmin/Message.php'>คลิ๊กที่นี่</a> เพื่อเข้าตรวจสอบ";
                    header("location: formAdd_message.php");
                    ...
                    $stmt->execute();
                    $_SESSION['success'] = "เพิ่มข่าวเรียบร้อยแล้ว! <a href='/Project_910_MATCHLIFE/Role_MasterAdmin/Message.php' class='alert-link'>คลิ๊กที่นี่</a> เพื่อเข้าตรวจสอบ";
                    header("location: formAdd_message.php");
                } else {
