...
<body>
    ...
    if(isset($_GET['id'])){
      ...
      if($stmt->rowCount() < 1){
          header('Location: /Project_910_MATCHLIFE/Role_MasterAdmin/Volunteer.php');
          exit();
      }
    }//isset
    ?>
            ...
            <div class="container-xl">
              <div class="border bg-surface-secondary h-full border-dashed rounded  justify-content-center align-items-center" style="min-height: 400px;">
                ...
                <div class="col">
                  ...
                  <form action="/Project_910_MATCHLIFE/Role_MasterAdmin/formedit_db_volunteer.php" method="post">

<div class="row">
        <div class="col">
          <div class="clearfix">
                            <img src="/Project_910_MATCHLIFE/Role_MasterAdmin/uploads/<?= $row['volu_img'];?>" width="50%" min-height="50%">
                        </div>
        </div>
                   ...
                   <div class="col">
                        ...
                        <input type="text" name="volu_location" class="form-control" value="<?= $row['volu_location'];?>" minlength="3">
                    </div>
