<?php 
    ...
    if (isset($_POST['formAdd']) && isset($_POST['volu_name']) && $_POST['volu_name'] >=0) {
        ...
        if (empty($volu_name)) {
            ...
            header("location: /Project_910_MATCHLIFE/Role_MasterAdmin/formAdd_volunteer.php");
            ...
            try {
                ...
                if ($row['volu_name'] == $volu_name) {
                    $_SESSION['warning'] = "มีกิจกรรมนี้อยู่ในระบบแล้ว <a href='/Project_910_MATCHLIFE/Role_MasterAdmin/Volunteer.php'>คลิ๊กที่นี่</a> เพื่อตรวจสอบข้อมูล";
                    header("location: /Project_910_MATCHLIFE/Role_MasterAdmin/formAdd_volunteer.php");
                    ...
                    $stmt->execute();
                    $_SESSION['success'] = "เพิ่มกิจกรรมเรียบร้อยแล้ว! <a href='/Project_910_MATCHLIFE/Role_MasterAdmin/Volunteer.php' class='alert-link'>คลิ๊กที่นี่</a> เพื่อตรวจสอบข้อมูล";
                    header("location: /Project_910_MATCHLIFE/Role_MasterAdmin/formAdd_volunteer.php");
                } else {
