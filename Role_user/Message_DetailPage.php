...
?>
  ...
  <?php
    if(isset($_GET['id'])){
      ...
      if($stmt->rowCount() < 1){
          header('Location: /Project_910_MATCHLIFE/Message_DetailPage.php');
          exit();
      }
    }//isset
    ?>
...
<div class="Name_Volunteer">
    <p>คลิ๊กที่นี่เพื่อย้อนกลับ <a href="/Project_910_MATCHLIFE/Role_user/Message.php">ย้อนกลับ</a></p>
<br>
    <h2><?= $row['message_name'];?></h2>
    <!--วันที่ใส่ข่าว-->
