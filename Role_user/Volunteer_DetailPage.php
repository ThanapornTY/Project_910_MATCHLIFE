...
<?php
            ...
            <?php 
            if($st->rowCount() == $row['volu_stdMax']){
                    echo '<a href="#" style="width:100%; color: #000;" class="btn btn-success btn-sm"><center>ฟอร์มนี้ลงทะเบียนเต็มแล้ว</center></a>';
                }else{
                    if(($us['id'] == $k['users_id']) > 0){
                        echo '<a href="#" style="width:100%; color: #000;" class="btn btn-success btn-sm"><center>บัญชีนี้ลงทะเบียนแล้ว</center></a>';
                    }else{
